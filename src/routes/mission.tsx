    ...
    <div className="mx-auto max-w-384 px-5 sm:px-10">
      <section className="scene border-b border-border/70 py-20 md:py-28">
        ...
        <div className="mt-10 grid gap-10 md:grid-cols-2">
          <p className="text-lg leading-relaxed text-muted-foreground">
            ...
            everyday experiences, strengthen businesses and institutions and contribute meaningfully
            to the digital transformation of Africa.
          </p>
          <p className="text-lg leading-relaxed text-muted-foreground">
            We are committed to moving technology beyond ideas and prototypes into practical,
            scalable products and services that people, businesses, governments and communities can
            rely on.
          </p>
        </div>
      </section>
      ...
      <section className="border-b border-border/70 bg-card/20 py-20 md:py-28">
        ...
        <blockquote className="mt-8 max-w-4xl border-l-2 border-primary pl-8 text-2xl leading-relaxed md:text-4xl">
          Our mission is to engineer innovative, accessible, and scalable technology solutions that
          solve real-world problems, connect people and businesses, transform traditional
        ...
        <p className="mt-10 max-w-2xl text-lg leading-relaxed text-muted-foreground">
          At 4First Technologies Limited, we are building with the belief that technology should not
          simply follow the future, it should help create it.
        </p>
      </section>
